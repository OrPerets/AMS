import { GardensWorkerReview } from '../../../../../components/gardens/GardensWorkerReview';

export default function GardensWorkerReviewPage({
  plan,
  workerProfileId,
}: {
  plan: string;
  ...
  return <GardensWorkerReview plan={plan} workerProfileId={workerProfileId} />;
}
