...
# Simple Multi-Architecture Docker Build for Railway
# This script uses Ubuntu base for better Prisma support
...
BACK_IMAGE_TAG="railway-simple"
FRONT_IMAGE_TAG="simple"

print_status "Starting Simple Multi-Architecture Docker Build"
echo "=================================================="
echo ""
...
print_status "Building Backend Multi-Architecture Image with Ubuntu base..."
...
# Summary
echo ""
print_success "🎉 Simple multi-architecture images built and pushed successfully!"
echo ""
