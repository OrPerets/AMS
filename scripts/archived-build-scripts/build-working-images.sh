...
# Build Working Docker Images with Custom Tags
# This script builds the working ARM64 images with specific tags
...
print_status "Building Working Docker Images with Custom Tags"
echo "=================================================="
echo ""
...
# Build Backend Image (ARM64 only with railway-fixed tag)
print_status "Building backend image with tag 'railway-fixed'..."
docker buildx build \
...
# Build Frontend Image (ARM64 only with latest tag)
print_status "Building frontend image with tag 'latest'..."
docker buildx build \
  --platform linux/arm64 \
...
print_success "Working images built and pushed successfully!"
echo ""
echo "🎉 Ready for deployment:"
echo "Backend Image:  $BACKEND_IMAGE"
echo "Frontend Image: $FRONTEND_IMAGE"
echo ""
print_warning "Note: These are ARM64-only images. Make sure your deployment platform supports ARM64."
echo ""
print_status "You can now deploy these images to Railway or any ARM64-compatible platform."
