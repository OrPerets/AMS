...
# ARM64-Only Docker Build for Railway
# This script builds only ARM64 architecture to avoid Prisma issues
...
BACK_IMAGE_TAG="railway-arm64"
FRONT_IMAGE_TAG="arm64"

print_status "Starting ARM64-Only Docker Build for Railway"
echo "=================================================="
echo ""
...
# Build Backend Image (ARM64 only)
print_status "Building backend image for ARM64 only..."
docker buildx build \
...
# Build Frontend Image (ARM64 only)
print_status "Building frontend image for ARM64 only..."
docker buildx build \
  --platform linux/arm64 \
...
print_success "ARM64-only build and push complete!"
echo "You can now deploy these images to Railway."
echo ""
echo "Backend Image: $BACKEND_IMAGE"
echo "Frontend Image: $FRONTEND_IMAGE"
echo ""
print_warning "Note: These images are ARM64-only. Make sure your deployment platform supports ARM64."
